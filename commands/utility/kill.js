...
module.exports = {
    ...
    //コマンド名前
        ...
        const server_owner = '1192986048213553213'
        const crw_technical = '1196278442153488485'
        const railroad_directive = '1192986404142207136'
        if (interaction.member.roles.cache.has(server_owner) || interaction.member.roles.cache.has(crw_technical) || interaction.member.roles.cache.has(railroad_directive)) {
